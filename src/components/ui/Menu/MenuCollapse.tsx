...
const MenuCollapse = (props: MenuCollapseProps) => {
    ...
    return (
        <div className="menu-collapse">
            <div
                className={`${menuCollapseItemClass} !hover:text-black`}
                role="presentation"
                onClick={toggleCollapse}
            >
                <span className="flex items-center text-white/80 ">{label}</span>
                <motion.span
                ...
                >
                    {sideCollapsed ? null : <HiChevronDown className="text-white/80" />}
                </motion.span>
            </div>
