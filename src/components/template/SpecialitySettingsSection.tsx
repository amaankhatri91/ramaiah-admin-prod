...
type SpecialitySettingsFormSchema = {
  pageType: string;
  pageName: string;
  seoTitle: string;
  seoKeyword: string;
...
const SpecialitySettingsSection = () => {
  const getInitialValues = (): SpecialitySettingsFormSchema => {
    return {
      pageType: "",
      pageName: "",
      seoTitle: "",
  ...
  const onSubmit = async (values: SpecialitySettingsFormSchema) => {
    try {
      // TODO: Implement API call to save page settings
      console.log("Speciality page settings to save:", values);
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <FormItem
                      ...
                      labelClass="text-[#495057] font-inter text-[14px] font-medium leading-normal"
                      invalid={
                        (errors.seoKeyword && touched.seoKeyword) as boolean
                      }
                    ...
                    <FormItem
                      ...
                      invalid={
                        (errors.seoDescription &&
                          touched.seoDescription) as boolean
                      }
...
export default SpecialitySettingsSection;
